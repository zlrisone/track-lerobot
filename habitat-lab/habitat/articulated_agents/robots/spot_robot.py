        ...
        return SpotParams(
            ...
            cameras={
                ...
                "articulated_agent_jaw_rgb": ArticulatedAgentCameraParams(
                    ...
                    cam_orientation=mn.Vector3(0, -1.571, 0), # 0 -1.571 0
                    attached_link_id=-1,
                ),
                "articulated_agent_right_rgb": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.24, 0.24, 0),
                    cam_orientation=mn.Vector3(0, 3.142, 0),
                    attached_link_id=-1,
                ),
                "articulated_agent_back_rgb": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.24, 0.24, 0),
                    cam_orientation=mn.Vector3(0, 1.571, 0),
                    attached_link_id=-1,
                ),
                "articulated_agent_left_rgb": ArticulatedAgentCameraParams(
                    cam_offset_pos=mn.Vector3(0.24, 0.24, 0),
                    cam_orientation=mn.Vector3(0, 0.0, 0),
                    attached_link_id=-1,
                ),
