...
@dataclass
class ForwardRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "articulated_agent_forward_rgb"
    width: int = 640
    height: int = 480
    hfov: int = 90

@dataclass
class RightRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "articulated_agent_right_rgb"
    width: int = 640
    height: int = 480
    hfov: int = 90
...
class BackRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "articulated_agent_back_rgb"
    width: int = 640
    height: int = 480
    hfov: int = 90

@dataclass
class LeftRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "articulated_agent_left_rgb"
    width: int = 640
    height: int = 480
    hfov: int = 90
...
@dataclass
class ShowAvatarRGBSensorConfig(HabitatSimRGBSensorConfig):
    uuid: str = "avatar_rgb"
    width: int = 3096
    height: int = 1200
...
cs.store(
    group="habitat/simulator/sim_sensors",
    name="forward_rgb_sensor",
    node=ForwardRGBSensorConfig,
)

cs.store(
    group="habitat/simulator/sim_sensors",
    name="right_rgb_sensor",
    node=RightRGBSensorConfig,
)
...
cs.store(
    group="habitat/simulator/sim_sensors",
    name="left_rgb_sensor",
    node=LeftRGBSensorConfig,
)
...
cs.store(
    group="habitat/simulator/sim_sensors",
    name="avatar_rgb_sensor",
    node=ShowAvatarRGBSensorConfig,
)
